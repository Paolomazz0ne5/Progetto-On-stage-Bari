...
// Dati degli eventi per il Teatro Petruzzelli
const TIMELINE_EVENTS = [
  { id: 'ev1', year: 1898, text: 'Inizio costruzione', color: '#FF9A9E' },
  { id: 'ev2', year: 1903, text: 'Inaugurazione ufficiale', color: '#FECFEF' },
  { id: 'ev3', year: 1973, text: 'Teatro di tradizione', color: '#A1C4FD' },
  { id: 'ev4', year: 1991, text: 'Devastante incendio', color: '#E2B0FF' },
  { id: 'ev5', year: 2009, text: 'Riapertura al pubblico', color: '#96FBC4' },
];
...
export default function TimelinePetruzzelliScreen() {
  const { completeMission } = useTheater();

  // State
  const [slots, setSlots] = useState<{ year: number; eventId: string | null }[]>([
    { year: 1898, eventId: null },
    { year: 1903, eventId: null },
    { year: 1973, eventId: null },
    { year: 1991, eventId: null },
    { year: 2009, eventId: null },
  ]);
  ...
  const handleClaimXP = () => {
    completeMission(14); // ID 14 per la timeline del Petruzzelli
    setShowVictoryModal(false);
    ...
    <GestureHandlerRootView style={styles.safeArea}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Timeline Petruzzelli</Text>
          <Pressable
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalCard}>
              ...
              <Text style={styles.modalText}>
                Hai ricostruito perfettamente la storia del Teatro Petruzzelli.
              </Text>
