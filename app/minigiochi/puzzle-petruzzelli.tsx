...
export default function PuzzlePetruzzelliScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Sfida Petruzzelli</Text>
      ...
      >
        ...
        <View style={styles.progressCard}>
          <Ionicons name="extension-puzzle" size={28} color="#E53935" style={styles.progressIcon} />
          <View style={{ flex: 1 }}>
                ...
                return (
                  ...
                  >
                    {pieceId !== null ? (
                      ...
                      >
                        <Image
                          source={require('../../assets/images/petruzzelli-facciata.png')}
                          style={[
                            styles.tileImage,
                            {
                              width: GRID_SIZE,
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalText}>
              Incredibile! Hai assemblato perfettamente lo storico Teatro Petruzzelli senza alcuna guida. Un vero maestro del puzzle!
            </Text>
