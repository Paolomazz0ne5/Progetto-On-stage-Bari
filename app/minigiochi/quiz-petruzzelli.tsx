...
const QUESTIONS: Record<Category, Question[]> = {
  curiosita: [
    {
      text: "Per cosa è famoso il Teatro Petruzzelli a livello nazionale?",
      options: [
        "È il quarto teatro italiano per dimensioni",
        "È l'unico teatro al mondo con due palchi",
        "È il teatro più antico del sud Italia",
        "Ospita la più grande collezione di costumi"
      ],
      correctIndex: 0,
    },
    {
      text: "Chi ha progettato il Teatro Petruzzelli?",
      options: [
        "Architetto Orazio Santalucia",
        "Ingegnere Angelo Messeni",
    ...
    {
      text: "Quale era l'occupazione principale dei fratelli Onofrio e Antonio Petruzzelli prima di costruire il teatro?",
      options: [
        "Banchieri",
        "Attori di teatro",
        "Commercianti e costruttori navali",
        "Politici locali"
      ],
      correctIndex: 2,
    }
  ...
  difficile: [
    {
      text: "Chi si occupò originariamente degli affreschi della cupola (poi andati distrutti e in parte rifatti)?",
      options: [
        "Raffaele Armenise",
        "Mario Sironi",
        "Corrado Cagli",
    ...
    {
      text: "Qual è la capienza attuale del Teatro Petruzzelli (circa)?",
      options: [
        "Oltre 3000 posti",
        "Circa 1500 posti (1482 per la precisione)",
        "Esattamente 800 posti",
        "Poco meno di 500 posti"
      ],
      correctIndex: 1,
    },
    {
      text: "Quale celebre artista internazionale della musica si è esibito al Teatro Petruzzelli?",
      options: [
        "The Beatles",
        "Elvis Presley",
        "Michael Jackson",
  ...
  facile: [
    {
      text: "Come si chiama il teatro distrutto da un grave incendio nella notte del 27 ottobre 1991?",
      options: [
        "Teatro Margherita",
        "Teatro Piccinni",
        "Teatro Petruzzelli",
    ...
    {
      text: "Di che colore è la facciata esterna del Teatro Petruzzelli?",
      options: [
        "Rosso porpora",
        "Giallo ocra",
        "Bianco marmo",
    ...
    {
      text: "In quale città si trova il Teatro Petruzzelli?",
      options: [
        "Lecce",
        "Bari",
        "Taranto",
  ...
  geografia: [
    {
      text: "Su quale importante corso di Bari si affaccia il Teatro Petruzzelli?",
      options: [
        "Corso Cavour",
    ...
    {
      text: "In quale quartiere di Bari è situato il Teatro Petruzzelli?",
      options: [
    ...
    {
      text: "Quale via fa angolo con l'ingresso principale del Teatro Petruzzelli su Corso Cavour?",
      options: [
        "Via Sparano",
        "Via Argiro",
        "Via Alberto Sordi",
  ...
  storia: [
    {
      text: "In quale anno è stato inaugurato il Teatro Petruzzelli?",
      options: [
        "1890",
        "1903",
        "1914",
    ...
    {
      text: "In quale anno il Teatro Petruzzelli ha subito un devastante incendio?",
      options: [
        "1985",
        "2001",
        "1979",
    ...
    {
      text: "Quando ha riaperto ufficialmente il Teatro Petruzzelli dopo l'incendio e i successivi restauri?",
      options: [
        "2009",
        "1995",
        "2015",
...
export default function QuizPetruzzelliScreen() {
  ...
  const handleOptionPress = (optionIdx: number) => {
    ...
    if (isCorrect) {
      ...
      setTimeout(() => {
        ...
        // Aggiunge XP globale (ID 13 per il quiz Petruzzelli)
        completeMission(13);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Quiz del Petruzzelli</Text>
      ...
      <Modal visible={showVictoryModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalText}>
              Incredibile! Hai risposto correttamente a tutte le 9 casse misteriose del Teatro Petruzzelli! Sei un vero esperto!
            </Text>
