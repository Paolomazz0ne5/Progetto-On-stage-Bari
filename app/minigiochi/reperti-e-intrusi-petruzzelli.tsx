...
const ITEMS: Item[] = [
  { id: 1, title: 'Dettaglio Facciata', isTheaterElement: true, image: require('../../assets/images/reperti-intrusi-petruzzelli/dettaglio-facciata.png') },
  { id: 2, title: 'Dettaglio Esterno', isTheaterElement: false, image: require('../../assets/images/reperti-intrusi-petruzzelli/dettaglio-esterno-intruso.png') },
  { id: 3, title: 'Interno Teatro', isTheaterElement: true, image: require('../../assets/images/reperti-intrusi-petruzzelli/interno-teatro.png') },
  { id: 4, title: 'Dettaglio Interno', isTheaterElement: false, image: require('../../assets/images/reperti-intrusi-petruzzelli/interno-intruso.png') },
  { id: 5, title: 'Cupola', isTheaterElement: true, image: require('../../assets/images/reperti-intrusi-petruzzelli/teatro-cupola.png') },
];

export default function RepertiIntrusiPetruzzelliScreen() {
  ...
  const handleSwipedRight = (cardIndex: number) => {
    ...
    if (item.isTheaterElement) {
      ...
      setModalContent({ type: 'success', title: 'ESATTO! 🎉', message: 'Corretto! È proprio del Teatro Petruzzelli.' });
  ...
  const handleSwipedLeft = (cardIndex: number) => {
    ...
    if (!item.isTheaterElement) {
      ...
      Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
      setModalContent({ type: 'error', title: 'SBAGLIATO! ❌', message: 'Sbagliato, questo appartiene al Teatro Petruzzelli!' });
      setModalVisible(true);
    }
  };

  const handleSwipedAll = () => {
    completeMission(15); // ID in games.ts for Reperti e Intrusi Petruzzelli
