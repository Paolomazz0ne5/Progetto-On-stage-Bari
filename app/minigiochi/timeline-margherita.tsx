...
const TIMELINE_EVENTS = [
  { id: 'ev1', year: 1910, text: 'Inaugurazione Varietà Margherita in legno su palafitte', color: '#FF9A9E' },
  { id: 'ev2', year: 1914, text: 'Inaugurazione attuale edificio in cemento armato', color: '#FECFEF' },
  { id: 'ev3', year: 1921, text: 'Inizio proiezioni cinematografiche', color: '#A1C4FD' },
  { id: 'ev4', year: 1980, text: 'Chiusura al pubblico', color: '#E2B0FF' },
  { id: 'ev5', year: 2018, text: 'Riapertura come polo espositivo', color: '#96FBC4' },
];
...
export default function TimelineMargheritaScreen() {
  const { completeMission } = useTheater();

  // State
  const [slots, setSlots] = useState<{ year: number; eventId: string | null }[]>([
    { year: 1910, eventId: null },
    { year: 1914, eventId: null },
    { year: 1921, eventId: null },
    { year: 1980, eventId: null },
    { year: 2018, eventId: null },
  ]);
    ...
    <GestureHandlerRootView style={styles.safeArea}>
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Timeline Margherita</Text>
          <Pressable
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalCard}>
              ...
              <Text style={styles.modalText}>
                Hai ricostruito perfettamente la storia del Teatro Margherita.
              </Text>
